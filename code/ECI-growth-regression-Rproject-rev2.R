...
data_reg_1962_1984_AVG <- data_reg_1962_1984_sub %>% 
  ...
  dplyr::summarize(
    eci_Mean = mean(eci, na.rm=TRUE), GDP_pc_growth_Mean = mean(GDP_pc_growth, na.rm=TRUE), Penn_GDP_PPP_log_Mean = mean(Penn_GDP_PPP_log, na.rm=TRUE), KOF_econ_Mean = mean(KOF_econ, na.rm=TRUE), pop_growth_Mean = mean(pop_growth, na.rm=TRUE), hc_Mean = mean(hc, na.rm=TRUE), inv_share_Mean = mean(inv_share, na.rm=TRUE))
...
data_reg_1985_2014_AVG <- data_reg_1985_2014 %>% 
  dplyr::group_by(ccode) %>% 
  dplyr::summarize(
    eci_Mean = mean(eci, na.rm=TRUE), GDP_pc_growth_Mean = mean(GDP_pc_growth, na.rm=TRUE), Penn_GDP_PPP_log_Mean = mean(Penn_GDP_PPP_log, na.rm=TRUE), KOF_econ_Mean = mean(KOF_econ, na.rm=TRUE), pop_growth_Mean = mean(pop_growth, na.rm=TRUE), hc_Mean = mean(hc, na.rm=TRUE), inv_share_Mean = mean(inv_share, na.rm=TRUE), primaryexports_Mean = mean(primary_exports_1_share_country, na.rm=TRUE), oilexports_Mean = mean(oil_exports_share_country, na.rm=TRUE), coalandmetalexports_Mean = mean(coal_and_metal_exports_share_country, na.rm=TRUE))

data_reg_1990_2010_AVG <- data_reg_1990_2010 %>% 
  dplyr::group_by(ccode) %>% 
  dplyr::summarize(
    eci_Mean = mean(eci, na.rm=TRUE), GDP_pc_growth_Mean = mean(GDP_pc_growth, na.rm=TRUE), Penn_GDP_PPP_log_Mean = mean(Penn_GDP_PPP_log, na.rm=TRUE), KOF_econ_Mean = mean(KOF_econ, na.rm=TRUE), pop_growth_Mean = mean(pop_growth, na.rm=TRUE), hc_Mean = mean(hc, na.rm=TRUE), inv_share_Mean = mean(inv_share, na.rm=TRUE), legalquality_Mean = mean(legal_rel, na.rm=TRUE), politicalquality_Mean = mean(political_rel, na.rm=TRUE), economicquality_Mean = mean(economic_rel, na.rm=TRUE), oilexports_Mean = mean(oil_exports_share_country, na.rm=TRUE), PropertyRights_Mean = mean(PropertyRights, na.rm=TRUE))
...
data_reg_sub <- select(data_reg, Year, ccode, eci, Penn_GDP_PPP_log, GDP_pc_growth, AdvancedCountry, HighIncome, LowIncome, LowerMiddleIncome, HigherMiddleIncome, pop_growth, hc, inv_share, OPECdummy)
...
data_reg_1985_and_2014 <- data.frame(data_reg_1985$ccode, data_reg_1985$Year, data_reg_1985$eci, data_reg_2014$eci, data_reg_1985$AdvancedCountry, data_reg_2014$AdvancedCountry, data_reg_1985$HighIncome, data_reg_2014$HighIncome, data_reg_1985$LowIncome, data_reg_2014$LowIncome, data_reg_1985$LowerMiddleIncome, data_reg_2014$LowerMiddleIncome, data_reg_1985$HigherMiddleIncome, data_reg_1985$pop_growth, data_reg_2014$pop_growth,  data_reg_1985$hc, data_reg_2014$hc, data_reg_1985$inv_share, data_reg_2014$inv_share, data_reg_1985$OPECdummy, data_reg_2014$OPECdummy)

#eci and GDP per capita for 1962, growth for average 1962-1984
data_reg_predict_1962_1984 <- data.frame(data_reg_1962$ccode, data_reg_1962$eci, data_reg_1962$Penn_GDP_PPP_log, data_reg_1962_1984_AVG$GDP_pc_growth_Mean, data_reg_1962$AdvancedCountry, data_reg_1962$HighIncome, data_reg_1962$LowIncome, data_reg_1962$LowerMiddleIncome, data_reg_1962$HigherMiddleIncome, data_reg_1962$pop_growth, data_reg_1962$hc, data_reg_1962$inv_share, data_reg_1962$OPECdummy)
colnames(data_reg_predict_1962_1984) <- c('ccode', 'eci_1962', 'GDP_pc_PPP_log_1962', 'avg_GDP_pc_PPP_growth_1962_1984', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')

#eci and GDP per capita for 1970, growth for average 1970-1984
data_reg_predict_1970_1984 <- data.frame(data_reg_1970$ccode, data_reg_1970$eci, data_reg_1970$Penn_GDP_PPP_log, data_reg_1970_1984_AVG$GDP_pc_growth_Mean, data_reg_1970_1984_AVG$KOF_econ_Mean, data_reg_1970$AdvancedCountry, data_reg_1970$HighIncome, data_reg_1970$LowIncome, data_reg_1970$LowerMiddleIncome, data_reg_1970$HigherMiddleIncome, data_reg_1970_1984_AVG$pop_growth_Mean, data_reg_1970_1984_AVG$hc_Mean, data_reg_1970_1984_AVG$inv_share_Mean, data_reg_1970$OPECdummy)
colnames(data_reg_predict_1970_1984) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')

#eci and GDP per capita for 1985, growth for average 1985-2014, rest of the variables: 1985-2014
data_reg_predict_1985_2014 <- data.frame(data_reg_1985$ccode, data_reg_1985$eci, data_reg_1985$Penn_GDP_PPP_log, data_reg_1985_2014_AVG$GDP_pc_growth_Mean, data_reg_1985_2014_AVG$KOF_econ_Mean, data_reg_1985$AdvancedCountry, data_reg_1985$HighIncome, data_reg_1985$LowIncome, data_reg_1985$LowerMiddleIncome, data_reg_1985$HigherMiddleIncome, data_reg_1985_2014_AVG$pop_growth_Mean, data_reg_1985_2014_AVG$hc_Mean, data_reg_1985_2014_AVG$inv_share_Mean, data_reg_1985$OPECdummy, data_reg_1985_2014_AVG$primaryexports_Mean, data_reg_1985_2014_AVG$oilexports_Mean, data_reg_1985_2014_AVG$coalandmetalexports_Mean)
colnames(data_reg_predict_1985_2014) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy', 'primaryexports', 'oilexports', 'coalandmetalexports')

#eci and GDP per capita for 1990, growth for average 1990-2010, rest of the variables: 1990-2010
data_reg_predict_1990_2010 <- data.frame(data_reg_1990$ccode, data_reg_1990$eci, data_reg_1990$Penn_GDP_PPP_log, data_reg_1990_2010_AVG$GDP_pc_growth_Mean, data_reg_1990_2010_AVG$KOF_econ_Mean, data_reg_1990$AdvancedCountry, data_reg_1990$HighIncome, data_reg_1990$LowIncome, data_reg_1990$LowerMiddleIncome, data_reg_1990$HigherMiddleIncome, data_reg_1990_2010_AVG$pop_growth_Mean, data_reg_1990_2010_AVG$hc_Mean, data_reg_1990_2010_AVG$inv_share_Mean, data_reg_1990$OPECdummy, data_reg_1990_2010_AVG$legalquality_Mean, data_reg_1990_2010_AVG$politicalquality_Mean, data_reg_1990_2010_AVG$economicquality_Mean, data_reg_1990_2010_AVG$oilexports_Mean, data_reg_1990_2010_AVG$PropertyRights_Mean)
colnames(data_reg_predict_1990_2010) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy', 'legalquality', 'politicalquality', 'economicquality', 'oilexports', 'propertyrights')

#eci, GDP per capita and natural resource variables for 1995, growth for average 1995-2014, rest of the variables: 1995-2014
data_reg_predict_1995_2014 <- data.frame(data_reg_1995$ccode, data_reg_1995$eci, data_reg_1995$Penn_GDP_PPP_log, data_reg_1995_2014_AVG$GDP_pc_growth_Mean, data_reg_1995_2014_AVG$KOF_econ_Mean, data_reg_1995$AdvancedCountry, data_reg_1995$HighIncome, data_reg_1995$LowIncome, data_reg_1995$LowerMiddleIncome, data_reg_1995$HigherMiddleIncome, data_reg_1995_2014_AVG$pop_growth_Mean, data_reg_1995_2014_AVG$hc_Mean, data_reg_1995_2014_AVG$inv_share_Mean, data_reg_1995$OPECdummy, data_reg_1995_2014_AVG$primaryexports_Mean, data_reg_1995_2014_AVG$naturalressourceexports_Mean)
colnames(data_reg_predict_1995_2014) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy', 'primaryexports', 'naturalressourceexports')

#eci and GDP per capita for 1985, growth for average 1985-1999
data_reg_predict_1985_1999 <- data.frame(data_reg_1985$ccode, data_reg_1985$eci, data_reg_1985$Penn_GDP_PPP_log, data_reg_1985_1999_AVG$GDP_pc_growth_Mean, data_reg_1985_1999_AVG$KOF_econ_Mean, data_reg_1985$AdvancedCountry, data_reg_1985$HighIncome, data_reg_1985$LowIncome, data_reg_1985$LowerMiddleIncome, data_reg_1985$HigherMiddleIncome, data_reg_1985_1999_AVG$pop_growth_Mean, data_reg_1985_1999_AVG$hc_Mean, data_reg_1985_1999_AVG$inv_share_Mean, data_reg_1985$OPECdummy)
colnames(data_reg_predict_1985_1999) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')

#eci and GDP per capita for 2000, growth for average 2000-2014
data_reg_predict_2000_2014 <- data.frame(data_reg_2000$ccode, data_reg_2000$eci, data_reg_2000$Penn_GDP_PPP_log, data_reg_2000_2014_AVG$GDP_pc_growth_Mean, data_reg_2000_2014_AVG$KOF_econ_Mean, data_reg_2000$AdvancedCountry, data_reg_1985$HighIncome, data_reg_1985$LowIncome, data_reg_1985$LowerMiddleIncome, data_reg_1985$HigherMiddleIncome, data_reg_2000_2014_AVG$pop_growth_Mean, data_reg_2000_2014_AVG$hc_Mean, data_reg_2000_2014_AVG$inv_share_Mean, data_reg_2000$OPECdummy)
colnames(data_reg_predict_2000_2014) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')

#eci and GDP per capita for 1985, growth for average 1985-1989
data_reg_predict_1985_1989 <- data.frame(data_reg_1985$ccode, data_reg_1985$eci, data_reg_1985$Penn_GDP_PPP_log, data_reg_1985_1989_AVG$GDP_pc_growth_Mean, data_reg_1985_1989_AVG$KOF_econ_Mean, data_reg_1985$AdvancedCountry, data_reg_1985$HighIncome, data_reg_1985$LowIncome, data_reg_1985$LowerMiddleIncome, data_reg_1985$HigherMiddleIncome, data_reg_1985_1989_AVG$pop_growth_Mean, data_reg_1985_1989_AVG$hc_Mean, data_reg_1985_1989_AVG$inv_share_Mean, data_reg_1985$OPECdummy)
colnames(data_reg_predict_1985_1989) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')

#eci and GDP per capita for 1990, growth for average 1990-1994
data_reg_predict_1990_1994 <- data.frame(data_reg_1990$ccode, data_reg_1990$eci, data_reg_1990$Penn_GDP_PPP_log, data_reg_1990_1994_AVG$GDP_pc_growth_Mean, data_reg_1990_1994_AVG$KOF_econ_Mean, data_reg_1990$AdvancedCountry, data_reg_1990$HighIncome, data_reg_1990$LowIncome, data_reg_1990$LowerMiddleIncome, data_reg_1990$HigherMiddleIncome, data_reg_1990_1994_AVG$pop_growth_Mean, data_reg_1990_1994_AVG$hc_Mean, data_reg_1990_1994_AVG$inv_share_Mean, data_reg_1990$OPECdummy)
colnames(data_reg_predict_1990_1994) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')

#eci and GDP per capita for 1995, growth for average 1995-1999
data_reg_predict_1995_1999 <- data.frame(data_reg_1995$ccode, data_reg_1995$eci, data_reg_1995$Penn_GDP_PPP_log, data_reg_1995_1999_AVG$GDP_pc_growth_Mean, data_reg_1995_1999_AVG$KOF_econ_Mean, data_reg_1995$AdvancedCountry, data_reg_1995$HighIncome, data_reg_1995$LowIncome, data_reg_1995$LowerMiddleIncome, data_reg_1995$HigherMiddleIncome, data_reg_1995_1999_AVG$pop_growth_Mean, data_reg_1995_1999_AVG$hc_Mean, data_reg_1995_1999_AVG$inv_share_Mean, data_reg_1995$OPECdummy)
colnames(data_reg_predict_1995_1999) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')

#eci and GDP per capita for 2000, growth for average 2000-2004
data_reg_predict_2000_2004 <- data.frame(data_reg_2000$ccode, data_reg_2000$eci, data_reg_2000$Penn_GDP_PPP_log, data_reg_2000_2004_AVG$GDP_pc_growth_Mean, data_reg_2000_2004_AVG$KOF_econ_Mean, data_reg_2000$AdvancedCountry, data_reg_2000$HighIncome, data_reg_2000$LowIncome, data_reg_2000$LowerMiddleIncome, data_reg_2000$HigherMiddleIncome, data_reg_2000_2004_AVG$pop_growth_Mean, data_reg_2000_2004_AVG$hc_Mean, data_reg_2000_2004_AVG$inv_share_Mean, data_reg_2000$OPECdummy)
colnames(data_reg_predict_2000_2004) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')

#eci and GDP per capita for 2005, growth for average 2005-2009
data_reg_predict_2005_2009 <- data.frame(data_reg_2005$ccode, data_reg_2005$eci, data_reg_2005$Penn_GDP_PPP_log, data_reg_2005_2009_AVG$GDP_pc_growth_Mean, data_reg_2005_2009_AVG$KOF_econ_Mean, data_reg_2005$AdvancedCountry, data_reg_2005$HighIncome, data_reg_2005$LowIncome, data_reg_2005$LowerMiddleIncome, data_reg_2005$HigherMiddleIncome, data_reg_2005_2009_AVG$pop_growth_Mean, data_reg_2005_2009_AVG$hc_Mean, data_reg_2005_2009_AVG$inv_share_Mean, data_reg_2005$OPECdummy)
colnames(data_reg_predict_2005_2009) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')

#eci and GDP per capita for 2000, growth for average 2000-2004
data_reg_predict_2010_2014 <- data.frame(data_reg_2010$ccode, data_reg_2010$eci, data_reg_2000$Penn_GDP_PPP_log, data_reg_2010_2014_AVG$GDP_pc_growth_Mean, data_reg_2010_2014_AVG$KOF_econ_Mean, data_reg_2010$AdvancedCountry, data_reg_2010$HighIncome, data_reg_2010$LowIncome, data_reg_2010$LowerMiddleIncome, data_reg_2010$HigherMiddleIncome, data_reg_2010_2014_AVG$pop_growth_Mean, data_reg_2010_2014_AVG$hc_Mean, data_reg_2010_2014_AVG$inv_share_Mean, data_reg_2010$OPECdummy)
colnames(data_reg_predict_2010_2014) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')
...
colnames(data_reg_predict_10year) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')
...
colnames(data_reg_predict_5year) <- c('ccode', 'eci', 'GDP_pc_PPP_log', 'avg_GDP_pc_PPP_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')
...
regression_data_5_year <- dplyr::select(regression_data_5_year, ccode, period, eci, Penn_GDP_PPP_log, GDP_pc_growth, KOF_econ, AdvancedCountry, HighIncome, LowIncome, LowerMiddleIncome, HigherMiddleIncome, pop_growth, hc, inv_share, OPECdummy)
regression_data_annual <- dplyr::select(data_reg_1985_2014, ccode, Year, eci, Penn_GDP_PPP_log, GDP_pc_growth, KOF_econ, AdvancedCountry, HighIncome, LowIncome, LowerMiddleIncome, HigherMiddleIncome, pop_growth, hc, inv_share, OPECdummy)
colnames(regression_data_5_year) <- c('ccode', 'period', 'eci', 'Penn_GDP_PPP_log', 'GDP_pc_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')
colnames(regression_data_annual) <- c('ccode', 'Year', 'eci', 'Penn_GDP_PPP_log', 'GDP_pc_growth', 'kof_econ', 'AdvancedCountry', 'HighIncome', 'LowIncome', 'LowerMiddleIncome', 'HigherMiddleIncome', 'popgrowth', 'humancapital', 'invest', 'OPECdummy')
...
data_reg_predict_1970_1984_select<-select(data_reg_predict_1970_1984, ccode, eci, GDP_pc_PPP_log, avg_GDP_pc_PPP_growth, kof_econ, popgrowth, humancapital, invest)
...
#eci*GDPpc (with investment share)
reg_predict_4_invest <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + invest + eci*GDP_pc_PPP_log, data=data_reg_predict_1985_2014, na.action=na.exclude)
summary(reg_predict_4_invest)
coeftest(reg_predict_4_invest, vcov=vcovHC)
...
#eci*GDPpc (with kof econ)
reg_predict_7 <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + popgrowth + humancapital + invest, data=data_reg_predict_1985_2014, na.action=na.exclude)
...
reg_predict_7_oilexports <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + oilexports + popgrowth + humancapital + invest, data=data_reg_predict_1985_2014, na.action=na.exclude)
summary(reg_predict_7_oilexports )
coeftest(reg_predict_7_oilexports , vcov=vcovHC)

#eci*GDPpc + coalandmetalexports (with kof econ)
reg_predict_7_coalandmetalexports <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + coalandmetalexports + popgrowth + humancapital + invest, data=data_reg_predict_1985_2014, na.action=na.exclude)
summary(reg_predict_7_coalandmetalexports )
coeftest(reg_predict_7_coalandmetalexports , vcov=vcovHC)

#
#eci*GDPpc + economicquality
reg_predict_7_economicquality <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + economicquality + popgrowth + humancapital + invest, data=data_reg_predict_1990_2010, na.action=na.exclude)
summary(reg_predict_7_economicquality)
coeftest(reg_predict_7_economicquality, vcov=vcovHC)

#eci*GDPpc + politicalquality
reg_predict_7_politicalquality <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + politicalquality + popgrowth + humancapital + invest, data=data_reg_predict_1990_2010, na.action=na.exclude)
...
reg_predict_7_politicalquality_oilexports <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + politicalquality + popgrowth + humancapital + invest + oilexports, data=data_reg_predict_1990_2010, na.action=na.exclude)
...
reg_predict_7_propertyrights <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + propertyrights + popgrowth + humancapital + invest, data=data_reg_predict_1990_2010, na.action=na.exclude)
...
reg_predict_7_propertyrights_oilexports <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + propertyrights + popgrowth + humancapital + invest + oilexports, data=data_reg_predict_1990_2010, na.action=na.exclude)
...
reg_predict_7_legalquality <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + legalquality + popgrowth + humancapital + invest, data=data_reg_predict_1990_2010, na.action=na.exclude)
...
ses.reg_predict_4_invest <- list(coeftest(reg_predict_4_invest, vcov.=function(x) vcovHC(x))[,2]) #heteroskedasticity-robust standard errors
tvals.reg_predict_4_invest <- list(coeftest(reg_predict_4_invest, vcov.=function(x) vcovHC(x))[,3]) #heteroskedasticity-robust t-values "group" ("time") accounts for serial (cross-sectional) correlation.
pvals.reg_predict_4_invest <- list(coeftest(reg_predict_4_invest, vcov.=function(x) vcovHC(x))[,4]) # heteroskedasticity-robust p-val
...
#5-year averages
reg_panel_5year_7 <- plm(GDP_pc_growth ~ lag(Penn_GDP_PPP_log, 1) + lag(eci,1) + kof_econ + lag(eci,1) * lag(Penn_GDP_PPP_log,1) + popgrowth + humancapital + invest, data=regression_data_5_year, index=c("ccode", "period"), model="pooling", na.action=na.exclude)
summary(reg_panel_5year_7)
coeftest(reg_panel_5year_7, vcov.=function(x) vcovHC(x, type="sss"))

#country-fixed effects
reg_panel_5year_7_cfe <- plm(GDP_pc_growth ~ lag(Penn_GDP_PPP_log, 1) + lag(eci,1) + kof_econ + lag(eci,1) * lag(Penn_GDP_PPP_log,1) + popgrowth + humancapital + invest, data=regression_data_5_year, index=c("ccode", "period"), model="within", effect="individual", na.action=na.exclude)
...
reg_panel_5year_7_ctfe <- plm(GDP_pc_growth ~ lag(Penn_GDP_PPP_log, 1) + lag(eci,1) + kof_econ + lag(eci,1) * lag(Penn_GDP_PPP_log,1) + popgrowth + humancapital + invest, data=regression_data_5_year, index=c("ccode", "period"), model="within", effect="twoways", na.action=na.exclude)
...
ses.reg_panel_5year_7_ctfe <- list(coeftest(reg_panel_5year_7_ctfe, vcov.=function(x) vcovHC(x, type="sss"))[,2]) #heteroskedasticity-robust standard errors
tvals.reg_panel_5year_7_ctfe <- list(coeftest(reg_panel_5year_7_ctfe, vcov.=function(x) vcovHC(x, type="sss"))[,3]) #heteroskedasticity-robust t-values "group" ("time") accounts for serial (cross-sectional) correlation.
pvals.reg_panel_5year_7_ctfe <- list(coeftest(reg_panel_5year_7_ctfe, vcov.=function(x) vcovHC(x, type="sss"))[,4]) # heteroskedasticity-robust p-val
...
reg_predict_7_developing <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + kof_econ + eci*GDP_pc_PPP_log + popgrowth + humancapital + invest, data=data_reg_predict_1985_2014_developing, na.action=na.exclude)
...
#1970-184
reg_predict_7_1970_1984 <- lm(avg_GDP_pc_PPP_growth ~ GDP_pc_PPP_log + eci*GDP_pc_PPP_log + kof_econ + popgrowth + humancapital + invest, data=data_reg_predict_1970_1984, na.action=na.exclude)
...
stargazer(reg_predict_1, reg_predict_2, reg_predict_4, reg_predict_4_kof, reg_predict_4_popgrowth, reg_predict_4_humancapital, reg_predict_4_invest, reg_predict_7, reg_panel_5year_7, reg_panel_5year_7_ctfe, t=list(unlist(tvals.reg_predict_1), unlist(tvals.reg_predict_2), unlist(tvals.reg_predict_4), unlist(tvals.reg_predict_4_kof), unlist(tvals.reg_predict_4_popgrowth), unlist(tvals.reg_predict_4_humancapital), unlist(tvals.reg_predict_4_invest), unlist(tvals.reg_predict_7), unlist(tvals.reg_panel_5year_7), unlist(tvals.reg_panel_5year_7_ctfe)), se=list(unlist(ses.reg_predict_1), unlist(ses.reg_predict_2), unlist(ses.reg_predict_4), unlist(ses.reg_predict_4_kof), unlist(ses.reg_predict_4_popgrowth), unlist(ses.reg_predict_4_humancapital), unlist(ses.reg_predict_4_invest), unlist(ses.reg_predict_7), unlist(ses.reg_panel_5year_7), unlist(ses.reg_panel_5year_7_ctfe)), p=list(unlist(pvals.reg_predict_1), unlist(pvals.reg_predict_2), unlist(pvals.reg_predict_4), unlist(pvals.reg_predict_4_kof), unlist(pvals.reg_predict_4_popgrowth), unlist(pvals.reg_predict_4_humancapital), unlist(pvals.reg_predict_4_invest), unlist(pvals.reg_predict_7), unlist(pvals.reg_panel_5year_7), unlist(pvals.reg_panel_5year_7_ctfe)), float = F, out = here::here("output/tex/Tab2_mainresults_raw_old.tex"))
